    ...
    <BrowserRouter>
      <div className="grid-container">
          ...
          <div>
            ...
            {userInfo && userInfo.isSeller && (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  <li>
                    <Link to="/productlist/seller" style={{textDecoration:"none"}}>Products</Link>
                  </li>
                  <li>
                    <Link to="/orderlist/seller" style={{textDecoration:"none"}}>Orders</Link>
                  </li>
                </ul>
              </div>
            )}
            {userInfo && userInfo.isAdmin && (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  ...
                  <li>
                    <Link to="/orderlist" style={{textDecoration:"none"}}>Orders</Link>
                  </li>
                  <li>
                    <Link to="/userlist" style={{textDecoration:"none"}}>Users</Link>
                  </li>
                </ul>
              </div>
            )}
        ...
        <aside className={sidebarIsOpen ? 'open' : ''}>
          <ul className="categories" style={{textDecoration:"none"}}>
            <li>
